...
The link at the end of each notebook opens the subsequent notebook.  [Return to README]([https://github.com/teresahanak/wikipedia-life-expectancy[@id='read'](https://github.com/teresahanak/wikipedia-life-expectancy/blob/main/README.md#read-the-project) links are available at the top and bottom of each notebook, to return to these insructions.
