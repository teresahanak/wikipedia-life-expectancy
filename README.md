...
3. The [pipelines.py](https://github.com/teresahanak/wikipedia-life-expectancy/blob/main/wikipedia_life_expectancy/pipelines.py) file is reused for all spiders within the Scrapy project folder, so requires updating to match the spider that will be crawled.
