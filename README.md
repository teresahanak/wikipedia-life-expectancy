...
Standalone contents and install/run instructions introduce each notebook, with a description of the data being loaded into the notebook.  Follow a notebook link to access that phase of the project.
