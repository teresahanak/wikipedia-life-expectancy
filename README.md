...
The number of references is easily scrapable and can represent the individual's notability, quantified.  With the addition of number of references (a proxy for notability) to the above information list, we have a framework for collecting the data.
