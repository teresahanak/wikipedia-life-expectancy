...
The number of references is easily scrapable and can represent the individual's notability, quantified.  With the number of references (a proxy for notability) added, the above list provides a framework for collecting the data.
