...
- *Mind vs Body Connection?*
    ...
    - In the champion model, *GBM2_tuned*, (known for) sports is the most important predictive feature.  (Known for) Sciences and (known for) spiritual are 9th and 14th, respectively.
- *Time will tell.*
