...
The number of references is easily scrapable and can represent the individual's notability, quantified.  The above list, with the addition of number of references (a proxy for notability) provide a framework for collecting the data.
