...
<a id=#read a></a>
## Explore the Project
The links below access the thirteen Jupyter Notebooks that encompass the project.  Standalone contents and install/run instructions introduce each notebook, with a description of the data being loaded into that notebook.
