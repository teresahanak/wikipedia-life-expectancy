...
4. Due to 1-3, reproducing the scraping steps for practice in Web scraping with Scrapy is recommended over aiming to duplicate the results here from start to finish.  For comparitive results, starting at any point after scraping is completed is recommended.
